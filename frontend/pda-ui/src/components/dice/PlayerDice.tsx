...
const DICE_FACES = [
  ...
  <div key="5" className="grid grid-cols-3 gap-2 w-full h-full p-4">
    ...
    <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)]"></div>
    <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)]"></div>
    <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)] col-start-2"></div>
    <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)]"></div>
    <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)]"></div>
    <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)]"></div>
    <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)]"></div>
...
export function PlayerDice({ value, isRolling = false, hasWon }: PlayerDiceProps) {
  ...
  const glowColor = hasWon 
    ? 'shadow-[0_0_30px_rgba(0,255,136,0.8),0_0_60px_rgba(0,255,136,0.5)]'
    : 'shadow-[0_0_20px_rgba(34,211,238,0.6),0_0_40px_rgba(34,211,238,0.3)]';

  return (
    <div className="relative">
      <div
        className={`
          relative w-32 h-32 bg-gradient-to-br from-cyan-900/50 to-cyan-950/50
      ...
      >
        ...
        {/* Corner accents */}
        <div className="absolute top-1 left-1 w-3 h-3 border-l-2 border-t-2 border-cyan-400/50 rounded-tl-lg"></div>
        <div className="absolute top-1 right-1 w-3 h-3 border-r-2 border-t-2 border-cyan-400/50 rounded-tr-lg"></div>
        <div className="absolute bottom-1 left-1 w-3 h-3 border-l-2 border-b-2 border-cyan-400/50 rounded-bl-lg"></div>
        <div className="absolute bottom-1 right-1 w-3 h-3 border-r-2 border-b-2 border-cyan-400/50 rounded-br-lg"></div>
      </div>
      
      {/* Label */}
      <div className="mt-4 text-center">
        <p className="text-cyan-400 font-bold text-lg">PLAYER</p>
        {value && !isRolling && (
          <p className="text-cyan-300 text-sm mt-1">Roll: {value}</p>
        )}
      </div>
    </div>
  );
